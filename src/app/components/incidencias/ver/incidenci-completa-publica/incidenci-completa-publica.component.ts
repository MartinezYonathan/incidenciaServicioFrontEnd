...
@Component({
  selector: 'app-incidenci-completa-publica',
  templateUrl: './incidenci-completa-publica.component.html',
  styleUrls: ['./incidenci-completa-publica.component.css']
})
export class IncidenciCompletaPublicaComponent implements OnInit {
